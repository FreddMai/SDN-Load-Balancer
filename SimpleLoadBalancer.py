...
dictReq = {'10.0.0.1' : 0, '10.0.0.2' : 0, '10.0.0.3' : 0, '10.0.0.4' : 0, '10.0.0.5' : 0, '10.0.0.6' : 0, '10.0.0.7' : 0, '10.0.0.8' : 0}
...
class SimpleLoadBalancer(object):
	...
	def _handle_ConnectionDown (self, event): 
		...
		fig, ax = plt.subplots()
		rects1 = ax.bar(ind, Counter, width, color='r', yerr=std)
		...
		ax.set_xticklabels(('10.0.0.5', '10.0.0.6', '10.0.0.7', '10.0.0.8'))
